<template>
    <div v-if="worksite" class="bg-white flex flex-col flex-grow">
        <div class="p-3 flex-grow intake-view">
            <div class="my-4">
                <label v-if="worksite.notes && worksite.notes.length > 0" class="my-1 text-xs font-bold text-gray-600 block">Notes</label>
            ...
            <div class="my-4" v-if="Object.keys(workTypesClaimedByOthers).length > 0">
                ...
                <div v-for="organization in Object.keys(workTypesClaimedByOthers)" class="my-1">
            ...
            <div class="my-4 border-t">
                <div v-if="Object.keys(workTypesClaimedByOthers).length > 0" class="my-4">
                    <div v-for="(work_types, organization) in workTypesClaimedByOthers">
                        <label class="my-4 text-xs font-bold text-gray-600">Claimed By
        ...
        <div class="bg-white p-3 border border-r-0 border-gray-300 card-footer flex justify-center items-center">
            <base-button v-if="workTypesClaimedByOrganization.length > 0" size="medium"
                         class="m-1 text-black p-3 px-4 border-2 border-black"
                         text="Unclaim" :action="() => { return unclaimWorkType() }"/>
            <base-button v-if="workTypesUnclaimed.length > 0" size="medium" type="primary"
                         class="m-1 text-black p-3 px-4"
                         text="Claim" :action="() => { return claimWorkType() }"/>
            <base-button v-if="Object.keys(workTypesClaimedByOthers).length > 0" size="medium"
                         class="m-1 text-black p-3 px-4 border-2 border-black"
    ...
    <a-skeleton class="bg-white h-full p-3 flex-grow" active v-else/>
</template>
